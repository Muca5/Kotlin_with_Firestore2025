...
fun RegisterScreen(
    ...
    // Cores do tema
    val primaryColor = Color(0xFF20b2aa) // Nova cor verde do primeiro código
    val primaryDarkColor = Color(0xFF5f9ea0)
    val textColor = Color.White
    val cardBackground = Color(0xFFdcdcdc) // Fundo escuro como no primeiro código
    val textColorDark = Color.Black // Texto branco como no primeiro código
    val labelColor = Color.Gray // Cor dos labels como no primeiro código

    // Gradiente de fundo
    val gradient = Brush.verticalGradient(
        colors = listOf(Color(0xFFf2f2f2), Color(0xFFf2f2f2)) // Fundo escuro sólido
    )
...
fun HomeScreen(
    ...
    val cardBackground = Color(0xFFdcdcdc)
